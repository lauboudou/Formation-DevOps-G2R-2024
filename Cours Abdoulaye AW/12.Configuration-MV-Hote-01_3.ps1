...
#Hote-01
#suite configuration des swtchs

Rename-NetAdapter -name "ethernet" -NewName MPIO1
New-NetIPAddress -InterfaceAlias MPIO1 -IPAddress 10.144.1.10 -PrefixLength 24
...
New-NetIPAddress -InterfaceAlias MPIO2 -IPAddress 10.144.2.10 -PrefixLength 24
...
New-NetIPAddress -InterfaceAlias PULSATION -IPAddress 10.144.3.10 -PrefixLength 24
